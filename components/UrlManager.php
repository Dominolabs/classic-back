...
/**
 * This class extends Yii UrlManager and adds features to detect the language
...
class UrlManager extends BaseUrlManager
{
     ...
     * `false` which will e.g.  redirect `de-AT` to `de-at`.
     */
    ...
    {
        $this->languages = Language::getCodesList();
    ...
    public function setDefaultLanguage()
    {
        ...
        if (!empty($languageId)) {
            $this->_defaultLanguage = Language::getLanguageCodeById($languageId);
        } else {
     ...
     * @return null|string|string[] fixed URL
     */
